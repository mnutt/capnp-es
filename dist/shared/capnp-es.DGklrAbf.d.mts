...
type CapnpSchemaTypeKind = "anyPointer" | "bool" | "data" | "enum" | "float32" | "float64" | "group" | "int16" | "int32" | "int64" | "int8" | "interface" | "list" | "struct" | "text" | "uint16" | "uint32" | "uint64" | "uint8" | "void";
interface CapnpSchemaTypeMetadata {
...
interface CapnpSchemaMetadata {
    readonly displayName: string;
    readonly id?: string;
    readonly typeId?: bigint;
    readonly typeIdHex?: string;
}
interface StructSchemaMetadata extends CapnpSchemaMetadata {
    readonly id: string;
    readonly typeId: bigint;
    readonly typeIdHex: string;
...
interface InterfaceSchemaMetadata extends CapnpSchemaMetadata {
    readonly id: string;
    readonly typeId: bigint;
    readonly typeIdHex: string;
    readonly size: ObjectSize;
...
interface _PointerCtor extends CapnpSchemaMetadata {
}
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly type: {
                ...
                readonly typeId: 10500036013887172658n;
                readonly typeIdHex: "91b79f1f808db032";
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 15430940935639230746n;
                readonly typeIdHex: "d625b7063acf691a";
                readonly displayName: "Exception";
            };
        }, {
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 16811039658553601732n;
                readonly typeIdHex: "e94ccf8031176ec4";
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 9469473312751832276n;
                readonly typeIdHex: "836a53ce789d4cd4";
                readonly displayName: "Call";
            };
        }, {
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 11392333052105676602n;
                readonly typeIdHex: "9e19b28d3db3573a";
                readonly displayName: "Return";
            };
        }, {
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 15239388059401719395n;
                readonly typeIdHex: "d37d2eb2c2f80e63";
                readonly displayName: "Finish";
            };
        }, {
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 13529541526594062446n;
                readonly typeIdHex: "bbc29655fa89086e";
                readonly displayName: "Resolve";
            };
        }, {
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 12473400923157197975n;
                readonly typeIdHex: "ad1a6c0d7dd07497";
                readonly displayName: "Release";
            };
        }, {
            readonly name: "disembargo";
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 17970548384007534353n;
                readonly typeIdHex: "f964368b0fbd3711";
                readonly displayName: "Disembargo";
            };
        }, {
            readonly name: "obsoleteSave";
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 11270825879279873114n;
                readonly typeIdHex: "9c6a046bfbc1ac5a";
                readonly displayName: "Provide";
            };
        }, {
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 15332985841292492822n;
                readonly typeIdHex: "d4c9b56290554016";
                readonly displayName: "Accept";
            };
        }, {
            readonly name: "join";
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 18149955118657700271n;
                readonly typeIdHex: "fbe1980490e001af";
...
declare class Bootstrap extends Struct {
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly name: "deprecatedObjectId";
            readonly codeOrder: 1;
            readonly ordinal: 1;
            readonly kind: "slot";
            readonly offset: 0;
...
declare class Call$1 extends Struct {
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 10789521159760378817n;
                readonly typeIdHex: "95bc14545813fbc1";
                readonly displayName: "MessageTarget";
            };
        }, {
            ...
            readonly name: "allowThirdPartyTailCall";
            readonly codeOrder: 4;
            readonly ordinal: 8;
            readonly kind: "slot";
            readonly offset: 128;
            ...
            readonly name: "noPromisePipelining";
            readonly codeOrder: 5;
            readonly ordinal: 9;
            readonly kind: "slot";
            readonly offset: 129;
            ...
            readonly name: "onlyPromisePipeline";
            readonly codeOrder: 6;
            readonly ordinal: 10;
            readonly kind: "slot";
            readonly offset: 130;
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 11100916931204903995n;
                readonly typeIdHex: "9a0e61223d96743b";
                readonly displayName: "Payload";
            };
        }, {
            readonly name: "sendResultsTo";
            readonly codeOrder: 8;
            readonly ordinal: 5;
            readonly kind: "group";
            readonly type: {
                readonly kind: "group";
                readonly typeId: 15774052265921044377n;
                readonly typeIdHex: "dae8b0f61aab5f99";
                readonly displayName: "sendResultsTo";
            };
        }];
...
declare class Return extends Struct {
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly name: "releaseParamCaps";
            readonly codeOrder: 1;
            readonly ordinal: 1;
            readonly kind: "slot";
            readonly offset: 32;
            ...
            readonly name: "resultsSentElsewhere";
            readonly codeOrder: 6;
            readonly ordinal: 5;
            readonly discriminantValue: 3;
            readonly kind: "slot";
            ...
            readonly name: "takeFromOtherQuestion";
            readonly codeOrder: 7;
            readonly ordinal: 6;
            readonly discriminantValue: 4;
            readonly kind: "slot";
            ...
            readonly name: "acceptFromThirdParty";
            readonly codeOrder: 8;
            readonly ordinal: 7;
            readonly discriminantValue: 5;
            readonly kind: "slot";
...
declare class Finish extends Struct {
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly name: "releaseResultCaps";
            readonly codeOrder: 1;
            readonly ordinal: 1;
            readonly kind: "slot";
            readonly offset: 32;
            ...
            readonly name: "requireEarlyCancellationWorkaround";
            readonly codeOrder: 2;
            readonly ordinal: 2;
            readonly kind: "slot";
            readonly offset: 33;
...
declare class Resolve extends Struct {
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 9593755465305995440n;
                readonly typeIdHex: "8523ddc40b86b8b0";
                readonly displayName: "CapDescriptor";
            };
        }, {
            readonly name: "exception";
            readonly codeOrder: 2;
...
declare class Disembargo_Context extends Struct {
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly name: "receiverLoopback";
            readonly codeOrder: 1;
            readonly ordinal: 2;
            readonly discriminantValue: 1;
            readonly kind: "slot";
...
declare class Disembargo extends Struct {
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly type: {
                readonly kind: "group";
                readonly typeId: 15376050949367520589n;
                readonly typeIdHex: "d562b4df655bdd4d";
...
declare class MessageTarget extends Struct {
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 15564635848320162976n;
                readonly typeIdHex: "d800b1d6cd6f1ca0";
                readonly displayName: "PromisedAnswer";
            };
        }];
    };
    /**
...
declare class CapDescriptor extends Struct {
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly name: "thirdPartyHosted";
            readonly codeOrder: 5;
            readonly ordinal: 5;
            readonly discriminantValue: 5;
            readonly kind: "slot";
            ...
            readonly type: {
                readonly kind: "struct";
                readonly typeId: 15235686326393111165n;
                readonly typeIdHex: "d37007fde1f0027d";
                readonly displayName: "ThirdPartyCapDescriptor";
            };
        }, {
            readonly name: "attachedFd";
            readonly codeOrder: 6;
            readonly ordinal: 6;
            readonly kind: "slot";
            readonly offset: 2;
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly type: {
                ...
                readonly elementType: {
                    readonly kind: "struct";
                    readonly typeId: 17516350820840804481n;
                    readonly typeIdHex: "f316944415569081";
                    readonly displayName: "Op";
                };
            };
        }];
    };
...
declare class Exception extends Struct {
    ...
    static readonly _capnp: {
        ...
        fields: readonly [{
            ...
            readonly type: {
                readonly kind: "enum";
                readonly typeId: 12865824133959433560n;
                readonly typeIdHex: "b28c96e23f4cbd58";
                readonly displayName: "Type";
            };
        }, {
            readonly name: "obsoleteIsCallersFault";
            readonly codeOrder: 2;
            readonly ordinal: 1;
            readonly kind: "slot";
            readonly offset: 0;
            ...
            readonly name: "obsoleteDurability";
            readonly codeOrder: 3;
            readonly ordinal: 2;
            readonly kind: "slot";
            readonly offset: 1;
...
interface InterfaceCtor<C, S extends Server> {
    readonly _capnp: CapnpSchemaMetadata & {
        id: string;
        size: ObjectSize;
    };
    readonly Client: {
...
declare class Message {
    ...
    static readonly toPackedUint8Array: typeof toPackedUint8Array;
    static readonly toUint8Array: typeof toUint8Array;
...
declare function toUint8Array(m: Message): Uint8Array;
declare function toPackedUint8Array(m: Message): Uint8Array;

export { Call_SendResultsTo as $, Conn as C, Deferred as D, Exception as E, answerPipelineClient as G, Interface as I, Message$1 as M, ObjectSize as O, Pointer as P, Struct as S, _capnpFileId as W, Message_Which as X, Bootstrap as Y, Call_SendResultsTo_Which as Z, Message as a, Call$1 as a0, Return_Which as a1, Return as a2, Finish as a3, Resolve_Which as a4, Resolve as a5, Release as a6, Disembargo_Context_Which as a7, Disembargo_Context as a8, Disembargo as a9, Provide as aa, Accept as ab, Join as ac, MessageTarget_Which as ad, MessageTarget as ae, Payload as af, CapDescriptor_Which as ag, CapDescriptor as ah, PromisedAnswer_Op_Which as ai, PromisedAnswer_Op as aj, PromisedAnswer as ak, ThirdPartyCapDescriptor as al, Orphan as b, Server as e, List as f, Exception_Type as j, ListElementSize as l, PointerType as m, Segment as n, readRawPointer as r, isFuncCall as t, isDataCall as u, copyCall as v, placeParams as w, isSameClient as x, clientFromResolution as y };
export type { Answer as A, BaseCall as B, Finalize as F, ServerMethod as H, ServerCall as J, CapnpSchemaTypeKind as K, ListCtor as L, CapnpSchemaTypeMetadata as N, CapnpFieldMetadata as Q, CapnpSchemaMetadata as R, Transport as T, StructSchemaMetadata as U, InterfaceSchemaMetadata as V, _StructCtor as _, Client as c, Method as d, PipelineOp as g, Call as h, StructCtor as i, PointerCtor as k, _ListCtor as o, _Pointer as p, FuncCall as q, DataCall as s, ImportEntry as z };
