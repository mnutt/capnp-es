import { J as initStruct, g as getPointer, K as FixedAnswer, M as getInterfaceClientOrNull, E as ErrorAnswer, k as getAs } from './capnp-es.d92Owwob.mjs';
import { M as Message } from './capnp-es.BbvJItGh.mjs';
import { l as Pointer, a3 as MAX_DEPTH, f as format, q as PointerType, A as getTargetPointerType, S as Struct, a4 as RPC_ERROR, a5 as RPC_CALL_QUEUE_FULL, a6 as INVARIANT_UNREACHABLE_CODE, a7 as RPC_QUEUE_CALL_CANCEL, u as RPC_NULL_CLIENT, c as copyFrom, a8 as RPC_METHOD_ERROR } from './capnp-es.DQO_cvul.mjs';
...
function exceptionTypeToCode(type) {
  switch (type) {
...
function codeToExceptionType(code) {
  switch (code) {
    case "overloaded": {
...
class CapnpRpcError extends Error {
  code;
  remoteReason;
  remoteTrace;
  exception;
  constructor(exceptionOrMessage, options = {}) {
    ...
    this.remoteTrace = exception.trace || void 0;
...
class MethodError extends CapnpRpcError {
  method;
...
export { CapnpRpcError as C, Deferred as D, Fulfiller as F, Interface as I, MethodError as M, Pipeline as P, Queue as Q, Registry as R, toException as a, PipelineClient as b, copyCall as c, isDataCall as d, exceptionTypeToCode as e, codeToExceptionType as f, isFuncCall as i, placeParams as p, transformPtr as t };
