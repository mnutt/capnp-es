import { c as Client, S as Struct, h as Call, A as Answer, d as Method, E as Exception, j as Exception_Type, f as List, P as Pointer, _ as _StructCtor, O as ObjectSize, i as StructCtor, L as ListCtor, k as PointerCtor, b as Orphan, l as ListElementSize, m as PointerType, n as Segment, a as Message, o as _ListCtor, I as Interface } from './shared/capnp-es.DGklrAbf.mjs';
export { B as BaseCall, Q as CapnpFieldMetadata, R as CapnpSchemaMetadata, K as CapnpSchemaTypeKind, N as CapnpSchemaTypeMetadata, C as Conn, s as DataCall, D as Deferred, q as FuncCall, z as ImportEntry, V as InterfaceSchemaMetadata, e as Server, J as ServerCall, H as ServerMethod, U as StructSchemaMetadata, T as Transport, p as _Pointer, G as answerPipelineClient, y as clientFromResolution, v as copyCall, u as isDataCall, t as isFuncCall, x as isSameClient, w as placeParams, r as readRawPointer } from './shared/capnp-es.DGklrAbf.mjs';
import { D as Data } from './shared/capnp-es.Bi8mSfW-.mjs';
export { P as Pipeline } from './shared/capnp-es.DTN0-JGa.mjs';
export { D as DeferredTransport } from './shared/capnp-es.3hLopMjX.mjs';
...
type CapnpRpcErrorCode = "failed" | "overloaded" | "disconnected" | "unimplemented";
declare function exceptionTypeToCode(type: Exception_Type): CapnpRpcErrorCode;
declare function codeToExceptionType(code: CapnpRpcErrorCode): Exception_Type;
interface CapnpRpcErrorOptions extends ErrorOptions {
    exception?: Exception;
    code?: CapnpRpcErrorCode;
    remoteReason?: string;
    remoteTrace?: string;
}
declare class CapnpRpcError extends Error {
...
declare function toException(exc: Exception, err: Error): void;
...
export { AnyPointerList, BoolList, Call, CapnpRpcError, Client, CompositeList, Data, DataList, ErrorClient, Float32List, Float64List, Int16List, Int32List, Int64List, Int8List, Interface, InterfaceList, JsonSturdyRefCodec, List, ListCtor, ListElementSize, MalformedSturdyRefError, MapRestorerLookup, Message, Method, ObjectSize, Orphan, Pointer, PointerList, PointerType, CapnpRpcError as RPCError, RealmTransformRegistry, Registry, Struct, StructCtor, Text, TextList, Uint16List, Uint32List, Uint64List, Uint8List, UnknownSturdyRefError, UnsupportedRealmTransformError, Void, VoidList, clientOrNull, codeToExceptionType, exceptionTypeToCode, getBitMask, getFloat32Mask, getFloat64Mask, getInt16Mask, getInt32Mask, getInt64Mask, getInt8Mask, getUint16Mask, getUint32Mask, getUint64Mask, getUint8Mask, toException, utils };
export type { CapnpRpcErrorCode, CapnpRpcErrorOptions, RealmTransform, RestorerLookup, SturdyRefCodec };
