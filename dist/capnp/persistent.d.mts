import { S as Struct, O as ObjectSize, b as Orphan, P as Pointer, c as Client, d as Method, e as Server, I as Interface } from '../shared/capnp-es.DGklrAbf.mjs';
import { P as Pipeline } from '../shared/capnp-es.DTN0-JGa.mjs';

declare const _capnpFileId = 13286472356248678103n;
...
declare class Persistent extends Interface {
    ...
    static readonly _capnp: {
        ...
        typeIdHex: string;
        size: ObjectSize;
        methods: [Method<Persistent_SaveParams, Persistent_SaveResults>];
    };
    toString(): string;
}
...
export type { Persistent$Server$Target };
