...
import { Annotation, Brand, Brand_Binding, Brand_Scope, ElementSize, Enumerant, Field, Method, Node, Node_NestedNode, Node_Parameter, Superclass, Type, Value } from "@mnutt/capnp-es/capnp/schema";
